...
La clase la cual servira para desde ahí se pueda cargar y guardar en excel todos los datos que introducimos desde la main, con un control de errores de códigos (ID de producto) duplicados o posibles errores de carga como “PermissionError” que ocurre cuando tenemos Excel abierto. 
